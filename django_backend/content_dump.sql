...
--
-- Name: articles_article; Type: TABLE; Schema: public; Owner: toshi
--
...
--
-- Name: articles_section; Type: TABLE; Schema: public; Owner: toshi
--
...
--
-- Name: articles_tag; Type: TABLE; Schema: public; Owner: toshi
--
...
CREATE TABLE public.articles_tag_articles (
    id bigint NOT NULL,
...
ALTER TABLE public.articles_tag_articles ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.articles_tag_articles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: articles_tag_id_seq; Type: SEQUENCE; Schema: public; Owner: toshi
--
...
COPY public.articles_section (id, name, slug) FROM stdin;
...
COPY public.articles_tag (id, name) FROM stdin;
1	technology
2	transistors
...
COPY public.articles_tag_articles (id, tag_id, article_id) FROM stdin;
1	1	1
2	2	1
3	3	1
4	4	1
...
--
-- Name: articles_article articles_article_pkey; Type: CONSTRAINT; Schema: public; Owner: toshi
--
...
--
-- Name: articles_article articles_article_slug_key; Type: CONSTRAINT; Schema: public; Owner: toshi
--
...
--
-- Name: articles_section articles_section_name_key; Type: CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_section
    ADD CONSTRAINT articles_section_name_key UNIQUE (name);


--
-- Name: articles_section articles_section_pkey; Type: CONSTRAINT; Schema: public; Owner: toshi
--
...
--
-- Name: articles_section articles_section_slug_key; Type: CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_section
    ADD CONSTRAINT articles_section_slug_key UNIQUE (slug);


--
-- Name: articles_tag_articles articles_tag_articles_pkey; Type: CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_tag_articles
    ADD CONSTRAINT articles_tag_articles_pkey PRIMARY KEY (id);


--
-- Name: articles_tag_articles articles_tag_articles_tag_id_article_id_0b1111ad_uniq; Type: CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_tag_articles
    ADD CONSTRAINT articles_tag_articles_tag_id_article_id_0b1111ad_uniq UNIQUE (tag_id, article_id);


--
-- Name: articles_tag articles_tag_name_key; Type: CONSTRAINT; Schema: public; Owner: toshi
--
...
--
-- Name: articles_tag articles_tag_pkey; Type: CONSTRAINT; Schema: public; Owner: toshi
--
...
--
-- Name: articles_article_section_id_624070f6; Type: INDEX; Schema: public; Owner: toshi
--

CREATE INDEX articles_article_section_id_624070f6 ON public.articles_article USING btree (section_id);


--
-- Name: articles_article_slug_cc61df93_like; Type: INDEX; Schema: public; Owner: toshi
--
...
--
-- Name: articles_section_name_79ba4087_like; Type: INDEX; Schema: public; Owner: toshi
--

CREATE INDEX articles_section_name_79ba4087_like ON public.articles_section USING btree (name varchar_pattern_ops);


--
-- Name: articles_section_slug_e0f944a9_like; Type: INDEX; Schema: public; Owner: toshi
--

CREATE INDEX articles_section_slug_e0f944a9_like ON public.articles_section USING btree (slug varchar_pattern_ops);


--
-- Name: articles_tag_articles_article_id_8bc85443; Type: INDEX; Schema: public; Owner: toshi
--

CREATE INDEX articles_tag_articles_article_id_8bc85443 ON public.articles_tag_articles USING btree (article_id);


--
-- Name: articles_tag_articles_tag_id_82ce8a67; Type: INDEX; Schema: public; Owner: toshi
--

CREATE INDEX articles_tag_articles_tag_id_82ce8a67 ON public.articles_tag_articles USING btree (tag_id);


--
-- Name: articles_tag_name_5be47acd_like; Type: INDEX; Schema: public; Owner: toshi
--
...
--
-- Name: articles_article articles_article_section_id_624070f6_fk_articles_section_id; Type: FK CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_article
    ADD CONSTRAINT articles_article_section_id_624070f6_fk_articles_section_id FOREIGN KEY (section_id) REFERENCES public.articles_section(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: articles_tag_articles articles_tag_article_article_id_8bc85443_fk_articles_; Type: FK CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_tag_articles
    ADD CONSTRAINT articles_tag_article_article_id_8bc85443_fk_articles_ FOREIGN KEY (article_id) REFERENCES public.articles_article(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: articles_tag_articles articles_tag_articles_tag_id_82ce8a67_fk_articles_tag_id; Type: FK CONSTRAINT; Schema: public; Owner: toshi
--

ALTER TABLE ONLY public.articles_tag_articles
    ADD CONSTRAINT articles_tag_articles_tag_id_82ce8a67_fk_articles_tag_id FOREIGN KEY (tag_id) REFERENCES public.articles_tag(id) DEFERRABLE INITIALLY DEFERRED;
